...
const ItemOptions = class {
  ...
  render() {
    const mode = (0,_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_2__.b)(this);
    const isEnd = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_4__.n)(this.side);
    return (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_1__.H, {
      class: {
        [mode]: true,
...
const ItemSliding = class {
  ...
  connectedCallback() {
    ...
    return (0,C_Angular_projects_2pisysPPA_app_ver1_6_2pisysPPA_Ver_1_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.gesture = (yield Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./index-34cb2743.js */ 83443))).createGesture({
        el: _this2.el,
  ...
  open(side) {
    ...
    return (0,C_Angular_projects_2pisysPPA_app_ver1_6_2pisysPPA_Ver_1_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      side = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_4__.n)(side) ? 'end' : 'start';
  ...
  updateOptions() {
    ...
    return (0,C_Angular_projects_2pisysPPA_app_ver1_6_2pisysPPA_Ver_1_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      for (let i = 0; i < options.length; i++) {
        ...
        const side = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_4__.n)(option.side) ? 'end' : 'start';
