...
/* harmony import */ var _gesture_controller_31cb6bb9_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./gesture-controller-31cb6bb9.js */ 81435);
/* harmony import */ var _helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./helpers-1457892a.js */ 2134);
/* harmony import */ var _index_1e16c550_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./index-1e16c550.js */ 25683);
/* harmony import */ var _theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./theme-ff3fc52f.js */ 94254);
/* harmony import */ var _hardware_back_button_4a6b37fb_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./hardware-back-button-4a6b37fb.js */ 4781);
/* harmony import */ var _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./animation-822d986b.js */ 92810);
...
const Menu = class {
  ...
  sideChanged() {
    this.isEndSide = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_5__.n)(this.side);
  }
...
`);
      ...
      _index_1e16c550_js__WEBPACK_IMPORTED_MODULE_6__.m._register(_this);

      _this.gesture = (yield Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./index-34cb2743.js */ 83443))).createGesture({
        el: document,
  ...
  componentWillLoad() {
    this.inheritedAttributes = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_5__.i)(this.el);
  }
  ...
  disconnectedCallback() {
    ...
    _index_1e16c550_js__WEBPACK_IMPORTED_MODULE_6__.m._unregister(this);
  ...
  setOpen(shouldOpen, animated = true) {
    return _index_1e16c550_js__WEBPACK_IMPORTED_MODULE_6__.m._setOpen(this, shouldOpen, animated);
  }
  ...
  loadAnimation() {
    ...
    return (0,C_Angular_projects_2pisysPPA_app_ver1_6_2pisysPPA_Ver_1_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this4.animation = yield _index_1e16c550_js__WEBPACK_IMPORTED_MODULE_6__.m._createAnimation(_this4.type, _this4);
  ...
  canStart(detail) {
    ...
    } else if (_index_1e16c550_js__WEBPACK_IMPORTED_MODULE_6__.m._getOpenSync()) {
      return false;
    }
  ...
  onStart() {
    if (!this.isAnimating || !this.animation) {
      (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_5__.m)(false, 'isAnimating has to be true');
      return;
  ...
  onEnd(detail) {
    ...
    newStepValue += (0,_cubic_bezier_eea9a7a9_js__WEBPACK_IMPORTED_MODULE_3__.g)([0, 0], [0.4, 0], [0.6, 1], [1, 1], (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_5__.k)(0, adjustedStepValue, 0.9999))[0] || 0;
  ...
  beforeAnimation(shouldOpen) {
    (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_5__.m)(!this.isAnimating, '_before() should not be called while animating'); // this places the menu into the correct location before it animates in
  ...
  afterAnimation(isOpen) {
    (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_5__.m)(this.isAnimating, '_before() should be called while animating'); // keep opening/closing the menu disabled for a touch more yet
  ...
  updateState() {
    ...
    if (!this.disabled) {
      _index_1e16c550_js__WEBPACK_IMPORTED_MODULE_6__.m._setActiveMenu(this);
    }

    (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_5__.m)(!this.isAnimating, 'can not be animating');
  }

  forceClosing() {
    (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_5__.m)(this._isOpen, 'menu cannot be closed');
    this.isAnimating = true;
...
const updateVisibility = /*#__PURE__*/function () {
  var _ref = (0,C_Angular_projects_2pisysPPA_app_ver1_6_2pisysPPA_Ver_1_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (menu) {
    const menuEl = yield _index_1e16c550_js__WEBPACK_IMPORTED_MODULE_6__.m.get(menu);
...
const MenuButton = class {
  constructor(hostRef) {
    ...
    this.type = 'button';
    this.onClick = /*#__PURE__*/(0,C_Angular_projects_2pisysPPA_app_ver1_6_2pisysPPA_Ver_1_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return _index_1e16c550_js__WEBPACK_IMPORTED_MODULE_6__.m.toggle(_this6.menu);
    });
  }
...
const MenuToggle = class {
  constructor(hostRef) {
    ...
    this.onClick = () => {
      return _index_1e16c550_js__WEBPACK_IMPORTED_MODULE_6__.m.toggle(this.menu);
    };
  }
