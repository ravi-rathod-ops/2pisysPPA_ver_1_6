...
const Range = class {
  constructor(hostRef) {
    ...
    this.clampBounds = value => {
      return (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_3__.k)(this.min, value, this.max);
    };
    ...
    this.setupGesture = /*#__PURE__*/(0,C_Angular_projects_2pisysPPA_app_ver1_6_2pisysPPA_Ver_1_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    this.handleKeyboard = (knob, isIncrease) => {
      ...
      if (knob === 'A') {
        this.ratioA = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_3__.k)(0, this.ratioA + step, 1);
      } else {
        this.ratioB = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_3__.k)(0, this.ratioB + step, 1);
      }
  ...
  debounceChanged() {
    this.ionChange = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_3__.f)(this.ionChange, this.debounce);
  }
  ...
  onStart(detail) {
    ...
    let ratio = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_3__.k)(0, (currentX - rect.left) / rect.width, 1);
  ...
  render() {
    ...
    let {
      labelText
    } = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_3__.d)(el, rangeId);
    ...
    (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_3__.e)(true, el, this.name, JSON.stringify(this.getValue()), disabled);
...
const ratioToValue = (ratio, min, max, step) => {
  ...
  return (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_3__.k)(min, value, max);
};

const valueToRatio = (value, min, max) => {
  return (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_3__.k)(0, (value - min) / (max - min), 1);
};
