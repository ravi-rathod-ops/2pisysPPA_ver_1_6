...
/* harmony import */ var _helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./helpers-1457892a.js */ 2134);
/* harmony import */ var _hardware_back_button_4a6b37fb_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./hardware-back-button-4a6b37fb.js */ 4781);
...
const mdEnterAnimation = (baseEl, ev) => {
  ...
  const backdropAnimation = (0,_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_7__.c)();
  const wrapperAnimation = (0,_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_7__.c)();
  const contentAnimation = (0,_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_7__.c)();
  const viewportAnimation = (0,_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_7__.c)();
  backdropAnimation.addElement(baseEl.querySelector('ion-backdrop')).fromTo('opacity', 0.01, 'var(--backdrop-opacity)').beforeStyles({
    'pointer-events': 'none'
  }).afterClearStyles(['pointer-events']);
  wrapperAnimation.addElement(baseEl.querySelector('.popover-wrapper')).fromTo('opacity', 0.01, 1);
...
const Popover = class {
  ...
  present() {
    ...
    return (0,C_Angular_projects_2pisysPPA_app_ver1_6_2pisysPPA_Ver_1_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this.usersElement = yield (0,_framework_delegate_94e770cc_js__WEBPACK_IMPORTED_MODULE_3__.a)(_this.delegate, container, _this.component, ['popover-viewport', _this.el['s-sc']], data);
      yield (0,_index_a7711c1e_js__WEBPACK_IMPORTED_MODULE_6__.e)(_this.usersElement);
      return (0,_overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_4__.d)(_this, 'popoverEnter', iosEnterAnimation, mdEnterAnimation, _this.event);
    })();
  }
  /**
  ...
  dismiss(data, role) {
    ...
    return (0,C_Angular_projects_2pisysPPA_app_ver1_6_2pisysPPA_Ver_1_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const shouldDismiss = yield (0,_overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_4__.f)(_this2, data, role, 'popoverLeave', iosLeaveAnimation, mdLeaveAnimation, _this2.event);

      if (shouldDismiss) {
        yield (0,_framework_delegate_94e770cc_js__WEBPACK_IMPORTED_MODULE_3__.d)(_this2.delegate, _this2.usersElement);
      }
  ...
  onDidDismiss() {
    return (0,_overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_4__.g)(this.el, 'ionPopoverDidDismiss');
  }
  /**
  ...
  onWillDismiss() {
    return (0,_overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_4__.g)(this.el, 'ionPopoverWillDismiss');
  }
