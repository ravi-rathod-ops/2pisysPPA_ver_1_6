...
/* harmony import */ var _cubic_bezier_eea9a7a9_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./cubic-bezier-eea9a7a9.js */ 12601);
/* harmony import */ var _helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./helpers-1457892a.js */ 2134);
/* harmony import */ var _haptic_27b3f981_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./haptic-27b3f981.js */ 59137);
/* harmony import */ var _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./animation-822d986b.js */ 92810);
/* harmony import */ var _index_9e3fe806_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./index-9e3fe806.js */ 81508);
/* harmony import */ var _spinner_configs_cd7845af_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./spinner-configs-cd7845af.js */ 91350);
...
const createBaseAnimation = pullingRefresherIcon => {
  ...
  const baseAnimation = (0,_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_6__.c)().duration(1000).easing('ease-out');
  const spinnerArrowContainerAnimation = (0,_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_6__.c)().addElement(spinnerArrowContainer).keyframes([{
    offset: 0,
    opacity: '0.3'
  }, {
    offset: 0.45,
  ...
  const circleInnerAnimation = (0,_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_6__.c)().addElement(circle).keyframes([{
    offset: 0,
  ...
  const circleOuterAnimation = (0,_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_6__.c)().addElement(spinner).keyframes([{
    offset: 0,
  ...
  if (arrowContainer && arrow) {
    const arrowContainerAnimation = (0,_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_6__.c)().addElement(arrowContainer).keyframes([{
      offset: 0,
    ...
    const arrowAnimation = (0,_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_6__.c)().addElement(arrow).keyframes([{
      offset: 0,
...
const createScaleAnimation = (pullingRefresherIcon, refresherEl) => {
  ...
  const spinnerAnimation = (0,_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_6__.c)().addElement(pullingRefresherIcon).keyframes([{
    offset: 0,
...
const createSnapBackAnimation = pullingRefresherIcon => {
  return (0,_animation_822d986b_js__WEBPACK_IMPORTED_MODULE_6__.c)().duration(125).addElement(pullingRefresherIcon).fromTo('transform', 'translateY(var(--ion-pulling-refresher-translate, 100px))', 'translateY(0px)');
...
const shouldUseNativeRefresher = /*#__PURE__*/function () {
  var _ref = (0,C_Angular_projects_2pisysPPA_app_ver1_6_2pisysPPA_Ver_1_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (referenceEl, mode) {
    ...
    yield new Promise(resolve => (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_4__.c)(refresherContent, resolve));
...
const Refresher = class {
  ...
  setupiOSNativeRefresher(pullingSpinner, refreshingSpinner) {
    ...
    return (0,C_Angular_projects_2pisysPPA_app_ver1_6_2pisysPPA_Ver_1_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        ...
        (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_1__.f)(() => {
          ...
          if (scrollTop > 0) {
            ...
            /* Refreshing */
              ...
              const ratio = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_4__.k)(0, scrollTop / (refresherHeight * 0.5), 1);
          ...
          const opacity = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_4__.k)(0, Math.abs(scrollTop) / refresherHeight, 0.99);
          const pullAmount = _this3.progress = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_4__.k)(0, (Math.abs(scrollTop) - 30) / MAX_PULL, 1);
          const currentTickToShow = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_4__.k)(0, Math.floor(pullAmount * NUM_TICKS), NUM_TICKS - 1);
      ...
      _this3.gesture = (yield Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./index-34cb2743.js */ 83443))).createGesture({
        el: _this3.scrollEl,
  ...
  setupMDNativeRefresher(contentEl, pullingSpinner, refreshingSpinner) {
    ...
    return (0,C_Angular_projects_2pisysPPA_app_ver1_6_2pisysPPA_Ver_1_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const circle = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_4__.g)(pullingSpinner).querySelector('circle');

      const pullingRefresherIcon = _this4.el.querySelector('ion-refresher-content .refresher-pulling-icon');

      const refreshingCircle = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_4__.g)(refreshingSpinner).querySelector('circle');
      ...
      _this4.gesture = (yield Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./index-34cb2743.js */ 83443))).createGesture({
        el: _this4.scrollEl,
        gestureName: 'refresher',
        gesturePriority: 31,
        direction: 'y',
        ...
        onMove: ev => {
          ...
          _this4.progress = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_4__.k)(0, ev.deltaY / 180 * 0.5, 1);
        ...
        onEnd: ev => {
          ...
          (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_1__.c)( /*#__PURE__*/(0,C_Angular_projects_2pisysPPA_app_ver1_6_2pisysPPA_Ver_1_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  connectedCallback() {
    ...
    return (0,C_Angular_projects_2pisysPPA_app_ver1_6_2pisysPPA_Ver_1_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      yield new Promise(resolve => (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_4__.c)(contentEl, resolve));
      _this6.scrollEl = yield contentEl.getScrollElement();
      _this6.backgroundContentEl = (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_4__.g)(contentEl).querySelector('#background-content');
      ...
      if (yield shouldUseNativeRefresher(_this6.el, (0,_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_2__.b)(_this6))) {
        ...
        _this6.gesture = (yield Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./index-34cb2743.js */ 83443))).createGesture({
          el: contentEl,
          gestureName: 'refresher',
          gesturePriority: 31,
          direction: 'y',
    ...
    return (0,C_Angular_projects_2pisysPPA_app_ver1_6_2pisysPPA_Ver_1_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this7.nativeRefresher) {
        ...
        if (!_this7.pointerDown) {
          (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => _this7.resetNativeRefresher(_this7.elementToTransform, 32
          /* Completing */
          )));
        }
      } else {
    ...
    return (0,C_Angular_projects_2pisysPPA_app_ver1_6_2pisysPPA_Ver_1_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this8.nativeRefresher) {
        ...
        if (!_this8.pointerDown) {
          (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => (0,_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => _this8.resetNativeRefresher(_this8.elementToTransform, 16
          /* Cancelling */
          )));
        }
      } else {
