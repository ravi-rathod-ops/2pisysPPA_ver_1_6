...
@Component({
  ...
  templateUrl: './compoundstock.page.html',
  styleUrls: ['./compoundstock.page.scss'],
})
export class CompoundstockPage implements OnInit {
  ...
  async getlink(){
    ...
    const headers = { 
      ...
      this.http.get<any>(this.dataUrl+'/api/reportlinks/cpdstk',{headers}).subscribe({
        next: async data => {
