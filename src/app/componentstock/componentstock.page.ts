...
@Component({
  ...
  templateUrl: './componentstock.page.html',
  styleUrls: ['./componentstock.page.scss'],
})
export class ComponentstockPage implements OnInit {
  ...
  async getlink(){
    ...
    const headers = { 
      ...
      this.http.get<any>(this.dataUrl+'/api/reportlinks/cmpdstk',{headers}).subscribe({
        next: async data => {
